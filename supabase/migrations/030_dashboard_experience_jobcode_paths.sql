...
experience as (
  select
    ...
    coalesce(nullif(r.json_data->>'jobcode_1', ''), jp.level1_name) as jobcode_level1,
    coalesce(nullif(r.json_data->>'jobcode_2', ''), jp.level2_name) as jobcode_level2,
    coalesce(nullif(r.json_data->>'jobcode_3', ''), jp.level3_name) as jobcode_level3,
    coalesce(
